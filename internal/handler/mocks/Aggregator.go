...
import (
	...
	service "ingestor/internal/service"
)
...
func (_m *Aggregator) GetAggregatedData() []service.AggregatedPulseDTO {
	ret := _m.Called()
	...
	var r0 []service.AggregatedPulseDTO
	if rf, ok := ret.Get(0).(func() []service.AggregatedPulseDTO); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]service.AggregatedPulseDTO)
		}
	}
...
func (_c *Aggregator_GetAggregatedData_Call) Return(_a0 []service.AggregatedPulseDTO) *Aggregator_GetAggregatedData_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *Aggregator_GetAggregatedData_Call) RunAndReturn(run func() []service.AggregatedPulseDTO) *Aggregator_GetAggregatedData_Call {
	_c.Call.Return(run)
	return _c
}
